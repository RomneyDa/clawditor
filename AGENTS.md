...
- Clawditor is new tooling. Do not preserve backward compatibility unless the user explicitly asks for it.
- Prefer the current CLI surface: `clawditor test <candidate>`.
